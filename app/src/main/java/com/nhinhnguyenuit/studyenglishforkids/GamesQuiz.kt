...
import com.nhinhnguyenuit.studyenglishforkids.databinding.ActivityGamesQuizBinding
...
class GamesQuiz : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonHelpQuiz.setOnClickListener {
            ...
            popuptext.text = "Chọn số lượng câu hỏi bạn muốn"
        ...
        binding.mulai.setOnClickListener {
            when (level) {
                "" -> {
                    Toast.makeText(this, "Chọn một cấp độ!", Toast.LENGTH_SHORT).show()
                }
