...
import com.nhinhnguyenuit.studyenglishforkids.databinding.ActivityHomeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonlearn.setOnClickListener {
            ...
            btnLearnXGames.setOnClickListener {
                val pindah = Intent(this, LearnAlphabet::class.java)
                epicDialog.dismiss()
                startActivity(pindah)
        ...
        binding.buttonHelpHomeActivity.setOnClickListener {
            ...
            helptext.text = "Chọn một trong các nút để học hoặc chơi"
